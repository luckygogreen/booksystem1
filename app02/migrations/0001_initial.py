    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adetails', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app02.authordetails')),
            ],
        ),
        migrations.CreateModel(
            name='publishinfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_pubish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app02.publishinfo')),
            ],
        ),
        migrations.CreateModel(
            name='authors_books',
            fields=[
                ...
                ('authorsid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app02.authorinfo')),
                ('booksid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app02.bookinfo')),
            ],
        ),
    ]
